{{-- <div class="fixed top-4 right-4 py-2 px-4 rounded-md shadow-md"
 ...
 role="alert"
 class="fixed top-8 right-8 rounded-md border-l-4 {{ $status === 'error' ? 'border-red-300 bg-red-100 text-red-700' : 'border-green-300 bg-green-100 text-green-700' }} p-4 opacity-75">
